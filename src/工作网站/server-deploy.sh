...
echo ""
echo "3. 🌐 访问方式："
echo "   游戏网站: https://m.game985.vip/"
echo "   原网站: https://ecpm.game985.vip/"
echo ""
echo "4. 🔧 配置Nginx："
echo "   上传配置文件: config/nginx-m-game.conf 到服务器 /etc/nginx/sites-available/"
echo "   创建符号链接: sudo ln -s /etc/nginx/sites-available/m-game /etc/nginx/sites-enabled/"
...
echo ""
echo "6. ✅ 测试访问："
echo "   打开浏览器访问: https://m.game985.vip/"
echo ""
echo "🎉 部署准备完成！"
echo ""
echo "💡 提示："
